...
--                       user_id INTEGER,
--                       date TEXT NOT NULL,
--                       score INTEGER,about:blank#blocked
--                       game TEXT NOT NULL);
...
--                              ('1', '2024-10-28', '2', 'Star Wars: Knights of the Old Repulic II'),
--                              ('2', '2024-10-29', '6', 'Zenless Zone Zero'),
--                              ('2', '2024-10-30', '0', 'Earthworm Jim'),
--                              ('3', '2024-10-31', '1', 'Yoshi""s  Island DS'),
--                              ('3', '2024-11-01', '1', 'The Witcher'),
--                              ('4', '2024-11-02', '3', 'Abe""s Odyssey'),
--                              ('4', '2024-11-03', '5', 'SCP: Secret Laboratory'),
--                              ('5', '2024-11-04', '3', 'Resident Evil 3'),
--                              ('5', '2024-11-05', '3', 'Dead Space 3');


-- ALTER TABLE `Guesses` ADD COLUMN reviews
